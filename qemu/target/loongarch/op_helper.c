...
void helper_ertn(CPULoongArchState *env)
{
    ...
    if (FIELD_EX64(env->CSR_TLBRERA, CSR_TLBRERA, ISTLBR)) {
        ...
        FIELD_DP64(env->CSR_CRMD, CSR_CRMD, DA, 0, env->CSR_CRMD);
        FIELD_DP64(env->CSR_CRMD, CSR_CRMD, PG, 1, env->CSR_CRMD);
    ...
    FIELD_DP64(env->CSR_CRMD, CSR_CRMD, PLV, csr_pplv, env->CSR_CRMD);
    FIELD_DP64(env->CSR_CRMD, CSR_CRMD, IE, csr_pie, env->CSR_CRMD);
