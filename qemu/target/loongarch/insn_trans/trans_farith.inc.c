...
static bool gen_fff(DisasContext *ctx, arg_fff *a,
                    void (*func)(TCGContext *, TCGv, TCGv_env, TCGv, TCGv))
{
    TCGContext *tcg_ctx = ctx->uc->tcg_ctx;
    func(tcg_ctx, tcg_ctx->cpu_fpr[a->fd], tcg_ctx->cpu_env, tcg_ctx->cpu_fpr[a->fj], tcg_ctx->cpu_fpr[a->fk]);
    return true;
}
...
{
    TCGContext *tcg_ctx = ctx->uc->tcg_ctx;
    func(tcg_ctx, tcg_ctx->cpu_fpr[a->fd], tcg_ctx->cpu_env, tcg_ctx->cpu_fpr[a->fj]);
    return true;
}

static bool gen_muladd(DisasContext *ctx, arg_ffff *a,
                       void (*func)(TCGContext *, TCGv, TCGv_env, TCGv, TCGv, TCGv, TCGv_i32),
                       int flag)
{
    TCGContext *tcg_ctx = ctx->uc->tcg_ctx;
    TCGv_i32 tflag = tcg_constant_i32(tcg_ctx, flag);
    func(tcg_ctx, tcg_ctx->cpu_fpr[a->fd], tcg_ctx->cpu_env, tcg_ctx->cpu_fpr[a->fj],
         tcg_ctx->cpu_fpr[a->fk], tcg_ctx->cpu_fpr[a->fa], tflag);
    return true;
}
...
{
    TCGContext *tcg_ctx = ctx->uc->tcg_ctx;
    tcg_gen_deposit_i64(tcg_ctx, tcg_ctx->cpu_fpr[a->fd], tcg_ctx->cpu_fpr[a->fk], tcg_ctx->cpu_fpr[a->fj], 0, 31);
    return true;
}
...
{
    TCGContext *tcg_ctx = ctx->uc->tcg_ctx;
    tcg_gen_deposit_i64(tcg_ctx, tcg_ctx->cpu_fpr[a->fd], tcg_ctx->cpu_fpr[a->fk], tcg_ctx->cpu_fpr[a->fj], 0, 63);
    return true;
}
...
{
    TCGContext *tcg_ctx = ctx->uc->tcg_ctx;
    tcg_gen_andi_i64(tcg_ctx, tcg_ctx->cpu_fpr[a->fd], tcg_ctx->cpu_fpr[a->fj], MAKE_64BIT_MASK(0, 31));
...
{
    TCGContext *tcg_ctx = ctx->uc->tcg_ctx;
    tcg_gen_andi_i64(tcg_ctx, tcg_ctx->cpu_fpr[a->fd], tcg_ctx->cpu_fpr[a->fj], MAKE_64BIT_MASK(0, 63));
    return true;
}
...
{
    TCGContext *tcg_ctx = ctx->uc->tcg_ctx;
    tcg_gen_xori_i64(tcg_ctx, tcg_ctx->cpu_fpr[a->fd], tcg_ctx->cpu_fpr[a->fj], 0x80000000);
    gen_nanbox_s(tcg_ctx, tcg_ctx->cpu_fpr[a->fd], tcg_ctx->cpu_fpr[a->fd]);
    return true;
}
...
{
    TCGContext *tcg_ctx = ctx->uc->tcg_ctx;
    tcg_gen_xori_i64(tcg_ctx, tcg_ctx->cpu_fpr[a->fd], tcg_ctx->cpu_fpr[a->fj], 0x8000000000000000LL);
    return true;
}
