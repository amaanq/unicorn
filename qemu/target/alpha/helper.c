                                ...
                                target_ulong *pphys, int *pprot)
{
    ...
    L1pte = glue(ldq_phys, UNICORN_ARCH_POSTFIX)(cs->uc, cs->as, pt + index*8);
    ...
    L2pte = glue(ldq_phys, UNICORN_ARCH_POSTFIX)(cs->uc, cs->as, pt + index*8);
    ...
    L3pte = glue(ldq_phys, UNICORN_ARCH_POSTFIX)(cs->uc, cs->as, pt + index*8);
