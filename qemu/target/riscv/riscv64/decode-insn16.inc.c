...
static bool decode_insn16(DisasContext *ctx, uint16_t insn)
{
    ...
    case 0x00002001:
        ...
        if ((insn & 0x00000f80) == 0x00000000) {
            /* 001.0000 0.....01 */
            /* /home/amaanq/projects/qemu/target/riscv/insn16-64.decode:25 */
            decode_insn16_extract_decode_insn16_Fmt_22(ctx, &u.f_empty, insn);
            if (trans_illegal(ctx, &u.f_empty)) return true;
        }
        /* /home/amaanq/projects/qemu/target/riscv/insn16-64.decode:26 */
        decode_insn16_extract_ci(ctx, &u.f_i, insn);
    ...
    case 0x00006000:
        /* 011..... ......00 */
        /* /home/amaanq/projects/qemu/target/riscv/insn16-64.decode:20 */
        decode_insn16_extract_cl_d(ctx, &u.f_i, insn);
    ...
    case 0x00006002:
        ...
        if ((insn & 0x00000f80) == 0x00000000) {
            /* 011.0000 0.....10 */
            /* /home/amaanq/projects/qemu/target/riscv/insn16-64.decode:33 */
            decode_insn16_extract_decode_insn16_Fmt_22(ctx, &u.f_empty, insn);
            if (trans_illegal(ctx, &u.f_empty)) return true;
        }
        /* /home/amaanq/projects/qemu/target/riscv/insn16-64.decode:34 */
        decode_insn16_extract_c_ldsp(ctx, &u.f_i, insn);
        if (trans_ld(ctx, &u.f_i)) return true;
        break;
    case 0x00008001:
        ...
        case 0x3:
            ...
            case 0x00001000:
                /* 100111.. .00...01 */
                /* /home/amaanq/projects/qemu/target/riscv/insn16-64.decode:28 */
                if (trans_subw(ctx, &u.f_r)) return true;
                break;
            case 0x00001020:
                /* 100111.. .01...01 */
                /* /home/amaanq/projects/qemu/target/riscv/insn16-64.decode:29 */
    ...
    case 0x0000e000:
        /* 111..... ......00 */
        /* /home/amaanq/projects/qemu/target/riscv/insn16-64.decode:21 */
        decode_insn16_extract_cs_d(ctx, &u.f_s, insn);
    ...
    case 0x0000e002:
        /* 111..... ......10 */
        /* /home/amaanq/projects/qemu/target/riscv/insn16-64.decode:36 */
        decode_insn16_extract_c_sdsp(ctx, &u.f_s, insn);
        if (trans_sd(ctx, &u.f_s)) return true;
        break;
    }
