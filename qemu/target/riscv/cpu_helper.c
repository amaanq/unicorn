                ...
                if (memory_region_is_ram(mr)) {
                    ...
                    *pte_pa = pte = updated_pte;
                    ...
                    target_ulong old_pte =
                        ...
                        qatomic_cmpxchg((long *)pte_pa, cpu_to_le32(pte), cpu_to_le32(updated_pte));
#else
                        qatomic_cmpxchg((long *)pte_pa, cpu_to_le64(pte), cpu_to_le64(updated_pte));
#endif /* TARGET_LONG_SIZE */
#else
#if TARGET_LONG_SIZE == 4
                        qatomic_cmpxchg(pte_pa, cpu_to_le32(pte), cpu_to_le32(updated_pte));
#else
                        qatomic_cmpxchg(pte_pa, cpu_to_le64(pte), cpu_to_le64(updated_pte));
#endif /* TARGET_LONG_SIZE */
#endif /* _MSC_VER */
                    if (old_pte != pte) {
                        goto restart;
