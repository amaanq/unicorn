...
static void disas_m_nocp_extract_disas_m_nocp_Fmt_1(DisasContext *ctx, arg_nocp *a, uint32_t insn)
{
    a->cp = extract32(insn, 8, 4);
}

static void disas_m_nocp_extract_disas_m_nocp_Fmt_2(DisasContext *ctx, arg_nocp *a, uint32_t insn)
{
    a->cp = 10;
}
...
static bool disas_m_nocp(DisasContext *ctx, uint32_t insn)
{
    ...
    case 0xec000000:
        ...
        if ((insn & 0x03000000) == 0x02000000) {
            /* 111.1110 ........ ........ ........ */
            disas_m_nocp_extract_disas_m_nocp_Fmt_1(ctx, &u.f_nocp, insn);
        ...
        if ((insn & 0x03000000) == 0x03000000) {
            /* 111.1111 ........ ........ ........ */
            disas_m_nocp_extract_disas_m_nocp_Fmt_2(ctx, &u.f_nocp, insn);
