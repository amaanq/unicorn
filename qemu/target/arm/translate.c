...
static inline void vfp_load_reg64(TCGContext *tcg_ctx, TCGv_i64 var, int reg)
{
    tcg_gen_ld_i64(tcg_ctx, var, tcg_ctx->cpu_env, vfp_reg_offset(true, reg));
}

static inline void vfp_store_reg64(TCGContext *tcg_ctx, TCGv_i64 var, int reg)
{
    tcg_gen_st_i64(tcg_ctx, var, tcg_ctx->cpu_env, vfp_reg_offset(true, reg));
}

static inline void vfp_load_reg32(TCGContext *tcg_ctx, TCGv_i32 var, int reg)
{
    tcg_gen_ld_i32(tcg_ctx, var, tcg_ctx->cpu_env, vfp_reg_offset(false, reg));
}

static inline void vfp_store_reg32(TCGContext *tcg_ctx, TCGv_i32 var, int reg)
{
    tcg_gen_st_i32(tcg_ctx, var, tcg_ctx->cpu_env, vfp_reg_offset(false, reg));
}

static void read_neon_element32(TCGContext *tcg_ctx, TCGv_i32 dest, int reg, int ele, MemOp memop)
{
...
static void read_neon_element64(TCGContext *tcg_ctx, TCGv_i64 dest, int reg, int ele, MemOp memop)
{
    long off = neon_element_offset(reg, ele, memop);
...
static void write_neon_element32(TCGContext *tcg_ctx, TCGv_i32 src, int reg, int ele, MemOp memop)
{
    long off = neon_element_offset(reg, ele, memop);
...
static void write_neon_element64(TCGContext *tcg_ctx, TCGv_i64 src, int reg, int ele, MemOp memop)
{
    long off = neon_element_offset(reg, ele, memop);
