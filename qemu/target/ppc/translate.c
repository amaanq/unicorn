...
{
    TCGContext *tcg_ctx = ctx->uc->tcg_ctx;
    tcg_gen_bswap64_i64(tcg_ctx, cpu_gpr[rA(ctx->opcode)], cpu_gpr[rS(ctx->opcode)]);
}
...
static void gen_brw(DisasContext *ctx)
{
    TCGContext *tcg_ctx = ctx->uc->tcg_ctx;
    tcg_gen_bswap64_i64(tcg_ctx, cpu_gpr[rA(ctx->opcode)], cpu_gpr[rS(ctx->opcode)]);
    tcg_gen_rotli_i64(tcg_ctx, cpu_gpr[rA(ctx->opcode)], cpu_gpr[rA(ctx->opcode)], 32);
...
static void gen_brh(DisasContext *ctx)
{
    ...
    tcg_gen_movi_i64(tcg_ctx, t0, 0x00ff00ff00ff00ffull);
    tcg_gen_shri_i64(tcg_ctx, t1, cpu_gpr[rS(ctx->opcode)], 8);
    tcg_gen_and_i64(tcg_ctx, t2, t1, t0);
    tcg_gen_and_i64(tcg_ctx, t1, cpu_gpr[rS(ctx->opcode)], t0);
