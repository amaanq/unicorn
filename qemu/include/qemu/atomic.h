...
#define qatomic_fetch_inc(ptr)         ((InterlockedIncrement(ptr))-1)
#define qatomic_fetch_dec(ptr)         ((InterlockedDecrement(ptr))+1)
#define qatomic_fetch_add(ptr, n)      ((InterlockedAdd(ptr,  n))-n)
#define qatomic_fetch_sub(ptr, n)      ((InterlockedAdd(ptr, -n))+n)
#define qatomic_fetch_and(ptr, n)      ((InterlockedAnd(ptr, n)))
#define qatomic_fetch_or(ptr, n)       ((InterlockedOr(ptr, n)))
#define qatomic_fetch_xor(ptr, n)      ((InterlockedXor(ptr, n)))

#define qatomic_inc_fetch(ptr)         (InterlockedIncrement((long*)(ptr)))
#define qatomic_dec_fetch(ptr)         (InterlockedDecrement((long*)(ptr)))
#define qatomic_add_fetch(ptr, n)      (InterlockedExchangeAdd((long*)ptr, n) + n)
#define qatomic_sub_fetch(ptr, n)      (InterlockedExchangeAdd((long*)ptr, n) - n)
#define qatomic_and_fetch(ptr, n)      (InterlockedAnd((long*)ptr, n) & n)
#define qatomic_or_fetch(ptr, n)       (InterlockedOr((long*)ptr, n) | n)
#define qatomic_xor_fetch(ptr, n)      (InterlockedXor((long*)ptr, n) ^ n)

#define qatomic_cmpxchg(ptr, old, new) ((InterlockedCompareExchange(ptr, old, new)))
#define qatomic_cmpxchg__nocheck(ptr, old, new)  qatomic_cmpxchg(ptr, old, new)

#define qatomic_inc(ptr)        ((void) InterlockedIncrement(ptr))
#define qatomic_dec(ptr)        ((void) InterlockedDecrement(ptr))
#define qatomic_add(ptr, n)     ((void) InterlockedAdd(ptr, n))
#define qatomic_sub(ptr, n)     ((void) InterlockedAdd(ptr, -n))
#define qatomic_and(ptr, n)     ((void) InterlockedAnd(ptr, n))
#define qatomic_or(ptr, n)      ((void) InterlockedOr(ptr, n))
#define qatomic_xor(ptr, n)     ((void) InterlockedXor(ptr, n))
#else // GCC/clang
